...
set ylabel "Time (s)" font ",40" offset 3,-0.3
set terminal postscript eps size 3, 3.7 enhanced color font ',45'
set output "../conv-only-train.eps"
...
plot "conv-only-train.csv" using 2:xtic(1) title "L=1" ls 1 lw 5, '' u 3 title "L=2" ls 2 lw 8, '' u 4 title "L=4" ls 3 lw 8, '' u 5 title "L=8" ls 4 lw 8
