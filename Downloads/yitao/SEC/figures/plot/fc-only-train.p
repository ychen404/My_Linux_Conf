...
set ylabel "Time (ms)" font ",40" offset 3.7,-0.3
set terminal postscript eps size 3, 3.7 enhanced color font ',45'
set output "../fc-only-train.eps"
#set output "fc-only-train.eps"
...
#set key at 2.75,250 samplen 3 width 0 spacing 1.2 height 1.7 font ",30" maxrows 4
#set nokey
...
plot "fc-only-train.csv" using 2:xtic(1) title "L=1" ls 1 lw 5, '' u 3 title "L=2" ls 2 lw 8, '' u 4 title "L=4" ls 3 lw 8, '' u 5 title "L=8" ls 4 lw 8
