...
set xlabel "Width" font ",40" offset 0,0
set ylabel "Time (s)" font ",40" offset 2,-0.3


set terminal postscript eps size 3, 3.7 enhanced color font ',30'
set output '../depconv-only-inference.eps'
...
#set key at 2.75,95 samplen 3 width 0 spacing 1.2 height 1.7 font ",30" maxrows 4
#set nokey
...
plot "depconv-only-inference.csv" using 2:xtic(1) title "DW-conv" ls 1 lw 5, \
'' u 3 title "Conv" ls 2 lw 8, \
