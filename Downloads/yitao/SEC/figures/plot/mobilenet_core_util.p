...
set ylabel "Core Utilization (%)" font ",32" offset 2.5,0
set terminal postscript eps size 4.75, 2.5 enhanced color font ',30'
set output "../mobilenet_core_util.eps"
set boxwidth 5
...
plot "mobilenet_core_util.csv" using 1:2 with boxes title "Pixel 2" fs fill solid 0.5 lt 3 , \
